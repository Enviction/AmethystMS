    ...
    if (status == 0) {
        ...
        if (selection == 1) {
            if (cm.haveItem(3010001)) {
                ...
                cm.sendOk("Hey, I dont think you have enough mesos or you didn't meet the requirement of level 10 ~ 200.");
            }
            cm.dispose();
        } else if (selection == 2) {
            status = 5;
