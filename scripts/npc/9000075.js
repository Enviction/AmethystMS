...
function action(mode, type, selection) {
	if (mode != 1) {
		...
		status++;
		if(status == 0){
			cm.sendSimple("Hello. Welcome to the Golden Temple Entrance. Where would you like to go? #rYou need a Golden Temple Ticket to enter. All these monsters drop Sunbursts, required to get into the boss Ravana.#k\r\n\r\n#b#L0#Goblin Temple 1 - Blue Goblin(2200 HP/170 EXP)#l\r\n#L1#Goblin Temple 2 - Red Goblin(4150 HP/336 EXP)#l\r\n#L2#Goblin Temple 3 - Stone Goblin(9300 HP/501 EXP)#l#k");
		} else if (status == 1) {
