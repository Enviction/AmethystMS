...
function start() {
	...
	if (cm.isGMS()) {
		...
		nitems = Array("2 million mesos", "5k Cash", "#v2340000#White Scroll (level 150+)", "#v2049100#Chaos Scroll x 5 (level 150+)", "#v5220000#Ga-cha-pon Ticket x 25", "#v5050000#AP Reset x 5", "#v5050000#AP Reset x 26", "#v5062000#Miracle Cube x 4", "#v5062000#Miracle Cube x 21", "#v2022179#Onyx Apple x 4", "#v2022179#Onyx Apple x 21", "#v5062001#Premium Miracle Cube x 2", "#v2530000#Lucky Day (level 150+)", "#v2531000#Protection Scroll (level 150+)");
		...
		nitems = Array("2 million mesos", "10k Cash", "#v2340000#White Scroll (level 150+)", "#v2049100#Chaos Scroll x 5 (level 150+)", "#v5220000#Ga-cha-pon Ticket x 25", "#v5050000#AP Reset x 5", "#v5050000#AP Reset x 26", "#v5062000#Miracle Cube x 4", "#v5062000#Miracle Cube x 21", "#v2022179#Onyx Apple x 4", "#v2022179#Onyx Apple x 21", "#v5062001#Premium Miracle Cube x 2", "#v2530000#Lucky Day (level 150+)", "#v2531000#Protection Scroll (level 150+)");
		np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
