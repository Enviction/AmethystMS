...
function start() {
	...
	if (cm.isGMS()) {
		...
		nitems = Array("2 million mesos", "5k Cash", "#v2340000#White Scroll (level 150+)", "#v2049122#Chaos Scroll x 5 (level 150+)", "#v5220000#Ga-cha-pon Ticket x 25", "#v5050000#AP Reset x 5", "#v5050000#AP Reset x 26", "#v5062000#Miracle Cube x 4", "#v5062000#Miracle Cube x 21", "#v2022179#Onyx Apple x 4", "#v2022179#Onyx Apple x 21", "#v5062001#Premium Miracle Cube x 2", "#v2530000#Lucky Day (level 150+)", "#v2531000#Protection Scroll (level 150+)");
		np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
		ditems = Array("#v5211067#1.2x EXP Card (1 Day)", "#v5211068#1.5x EXP Card (1 Day)", "#v5360000#2x Drop/Meso Card (1 Day)");
		...
		nitems = Array("2 million mesos", "10k Cash", "#v2340000#White Scroll (level 150+)", "#v2049122#Chaos Scroll x 5 (level 150+)", "#v5220000#Ga-cha-pon Ticket x 25", "#v5050000#AP Reset x 5", "#v5050000#AP Reset x 26", "#v5062000#Miracle Cube x 4", "#v5062000#Miracle Cube x 21", "#v2022179#Onyx Apple x 4", "#v2022179#Onyx Apple x 21", "#v5062001#Premium Miracle Cube x 2", "#v2530000#Lucky Day (level 150+)", "#v2531000#Protection Scroll (level 150+)");
		np = Array(2, 2, 10, 4, 2, 2, 10, 2, 10, 2, 10, 18, 10, 20);
		ditems = Array("#v5211074#1.2x EXP Card (1 Day)", "#v5211077#1.5x EXP Card (1 Day)", "#v5360017#2x Drop/Meso Card (1 Day)");
		dp = Array(8, 16, 6, 8, 8, 6);
	}
}
			...
			switch(selection) {
				...
				case 2:
					if (cm.getPlayer().getLevel() < 150) {
						cm.sendOk("You must be level 150 or above to get this item.");
				...
				case 3:
					if (cm.getPlayer().getLevel() < 150) {
						cm.sendOk("You must be level 150 or above to get this item.");
					} else if (!cm.canHold(2049122, 5)) {
						cm.sendOk("You have too much item.");
					} else {
						cm.gainItem(2049122, 5);
						passed = true;
					}
					break;
				case 4:
