...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable, MapleCharacterLook {
    ...
    public void occupationLevelUp(){ 
        ...
        dropMessage(6, "[Amethyst]: Occupation " + Occupations.getNameById(this.getOccId()) + " has LEVELED UP! You are now a Level " + this.getOccLevel() + " " + Occupations.getNameById(this.getOccId()) + "."); 
    }  
