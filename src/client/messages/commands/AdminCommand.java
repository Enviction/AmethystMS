            ...
            for (MapleMapObject item : items) {
                ...
                case "clisten":
                    for (MapleCharacter chars : World.getAllCharacters()) {
                        ...
                        player.dropMessage(6, "You stopped watching everyone in Amethyst.");
                    return true;
                case "listen":
                case "watchserver":
                    for (MapleCharacter chars : World.getAllCharacters()) {
                    ...
                    player.dropMessage(6, "You started watching everyone in Amethyst. Use '!clisten' to stop.");
                    return true;
                case "memory":
                case "ram":
               ...
               case "copyetc":
                ...
                case "insult1":
                   ...
                   //     }
                   // }
                    c.getChannelServer().broadcastPacket(CWvsContext.serverNotice(6, "[Amethyst's Insult System] : " + InsultBot.getInsult()));
                    return true;
                case "hairperson":
