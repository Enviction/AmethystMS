...
public class InterServerHandler {
    ...
    public static final void Loggedin(final int playerid, final MapleClient c) {
        ...
        if (player.getMap().getId() == MapConstants.STARTER_MAP) {
            World.Broadcast.broadcastMessage( CWvsContext.yellowChat("[" + c.getPlayer().getName() + "] Just Joined " + ServerConstants.SERVER_NAME + " - The Ultimate MapleStory Private Server!"));
