...
/*      */   }
  ...
  /*  public static boolean isDropRestricted(int itemId) {
   ...
   public static boolean isAngel(int sourceid) {
    ...
    public static final int[] publicNpcIds = {9070004, 9071003, 9010022, 9000087, 9000088, 9310008, 9010034, 9000039, 9200000};
    public static final String[] publicNpcs = {"Move to the #cBattle Square# to fight other players", 
        ...
        "Move to #cFree Market# to trade items with players.", "Move to #cArdentmill#, the crafting town.", "#cUniversal NPC#.", "#cVote NPC#.", 
