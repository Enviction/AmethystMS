...
public final class MapleMap {
    ...
    public final void killMonster(final MapleMonster monster, final MapleCharacter chr, final boolean withDrops, final boolean second, byte animation, final int lastSkill) {
        ...
        if (mobid == 9400566) {
            ...
            World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(5, "[GM-Message] Horntail was killed by : " + chr.getName()));
            ...
            World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(5, "[GM-Message] Chaos Horntail was killed by : " + chr.getName()));
            ...
            World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(5, "[GM-Message] Pink bean was killed by : " + chr.getName()));
            ...
            World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(5, "[GM-Message] Empress was killed by : " + chr.getName()));
